...
--
---- ********   VIDEO  ******
INSERT INTO [dbo].[videos] (title, file_path, thumbnail_url, duration_in_seconds, description, created_at) VALUES ('Titolo 1 del Video', '/path/to/file.mp4', '/path/to/thumbnail.jpg', 300, 'Descrizione del video', GETDATE());
INSERT INTO [dbo].[videos] (title, file_path, thumbnail_url, duration_in_seconds, description, created_at) VALUES ('Titolo 2 del Video', '/path/to/file.mp4', '/path/to/thumbnail.jpg', 300, 'Descrizione del video', GETDATE());
INSERT INTO [dbo].[videos] (title, file_path, thumbnail_url, duration_in_seconds, description, created_at) VALUES ('Titolo 3 del Video', '/path/to/file.mp4', '/path/to/thumbnail.jpg', 300, 'Descrizione del video', GETDATE());
INSERT INTO [dbo].[videos] (title, file_path, thumbnail_url, duration_in_seconds, description, created_at) VALUES ('Titolo 4 del Video', '/path/to/file.mp4', '/path/to/thumbnail.jpg', 300, 'Descrizione del video', GETDATE());
INSERT INTO [dbo].[videos] (title, file_path, thumbnail_url, duration_in_seconds, description, created_at) VALUES ('Titolo 5 del Video', '/path/to/file.mp4', '/path/to/thumbnail.jpg', 300, 'Descrizione del video', GETDATE());
